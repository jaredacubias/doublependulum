...
the equations of motion used are the following, derived from solving lagrange-euler equation:
...
rk4 is run 100 times each frame to determine the motion of each ball
